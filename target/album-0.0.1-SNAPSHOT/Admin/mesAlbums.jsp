            ...
            <div class="table-title">
                <div class="row">
                   <div class="col-sm-6">
                      ...
                      <a href="#addAlbum" data-toggle="modal"><input class="btn btn-success" value="Create new Album"></a>
                   </div>
                </div>
            </div>
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>Voyages</td>
                        <td>5</td>
                        <td>Photos de voyages</td>
                        <td>18/02/2020</td>
                        <td>
                            <a href="modifierAlbum.html" class="edit"><i class="material-icons" title="Edit">&#xE254;</i></a>
                            <a href="#deleteAlbum" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>18/02/2020</td>
                        <td>
                            <a href="modifierAlbum.jsp" class="edit"><i class="material-icons" title="Edit">&#xE254;</i></a>
                            <a href="#deleteAlbum" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                        </td>
                    </tr>
                </tbody>
      ...
      <div class="modal-content">
        <form>
          ...
          <div class="modal-body">
            ...
            <div class="form-check">
              <input type="radio" class="form-check-input" name="AlbumType" id="public" value="prive">
